...
/**
 * Representación del Estado de un Detalle de Pedido
 * 
 * <p>Clase Java para detallePedidoEstadoDTO complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="detallePedidoEstadoDTO"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "detallePedidoEstadoDTO", propOrder = {

})
public class DetallePedidoEstadoDTO
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DetallePedidoEstadoDTO)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DetallePedidoEstadoDTO that = ((DetallePedidoEstadoDTO) object);
        {
            int lhsId;
            lhsId = this.getId();
            int rhsId;
