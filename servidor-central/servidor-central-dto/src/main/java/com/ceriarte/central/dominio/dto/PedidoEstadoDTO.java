...
/**
 * Representación del Estado de un Pedido
 * 
 * <p>Clase Java para pedidoEstadoDTO complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="pedidoEstadoDTO"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "pedidoEstadoDTO", propOrder = {
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PedidoEstadoDTO)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PedidoEstadoDTO that = ((PedidoEstadoDTO) object);
        {
            int lhsId;
            lhsId = this.getId();
            int rhsId;
