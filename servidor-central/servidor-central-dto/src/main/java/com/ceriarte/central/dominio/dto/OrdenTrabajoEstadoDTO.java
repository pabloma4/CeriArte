...
/**
 * Representación del Estado de una Orden Trabajo
 * 
 * <p>Clase Java para ordenTrabajoEstadoDTO complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ordenTrabajoEstadoDTO"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ordenTrabajoEstadoDTO", propOrder = {

})
public class OrdenTrabajoEstadoDTO
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OrdenTrabajoEstadoDTO)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OrdenTrabajoEstadoDTO that = ((OrdenTrabajoEstadoDTO) object);
        {
            int lhsId;
            lhsId = this.getId();
            int rhsId;
